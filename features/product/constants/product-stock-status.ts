...
export const STOCK_STATUS_LABELS: Record<StockStatus, string> = {
  [STOCK_STATUSES.OUT_OF_STOCK]: "Out of Stock",
  [STOCK_STATUSES.LOW]: "Low Stock",
...
export const STOCK_STATUS_BADGES: Record<StockStatus, string> = {
  [STOCK_STATUSES.OUT_OF_STOCK]:
    "bg-gray-100 text-gray-700 border border-gray-200",

  [STOCK_STATUSES.LOW]: "bg-red-100 text-red-700 border border-red-200",
